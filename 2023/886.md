...
nav_order: 886
---
# 使用 VSCode 作为 ISE 的外部编辑器进行 Verilog 代码的编写、检查、格式化方法探究
<div class="post-info">
<span>沈锎</span>
|
...
![image.png](../assets/2023/886/image--1.png)
...
![image.png](../assets/2023/886/image--2.png)
...
![image.png](../assets/2023/886/image--3.png)
...
![image.png](../assets/2023/886/image--4.png)
...
![image.png](../assets/2023/886/image--5.png)
...
![image.png](../assets/2023/886/image--6.png)
...
![image.png](../assets/2023/886/image--7.png)
...
![image.png](../assets/2023/886/image--8.png)

下面，是我在使用中遇到的一个问题及解决方法。

在写 test bench 时需要对模块进行例化，但是 iverilog 并不能将其识别，而会显示模块未知。

![image.png](../assets/2023/886/image--9.png)
...
![image.png](../assets/2023/886/image--10.png)
